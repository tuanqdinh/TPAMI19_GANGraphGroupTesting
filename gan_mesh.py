...
output_path = os.path.join(args.result_path, output_folder)
...
#####--------------Training----------------------------
netG_path = os.path.join(model_path, 'mesh-netG-99-14.pth')
netD_path = os.path.join(model_path, 'mesh-netD-99-14.pth')
...
generate_image(netG, frame_index=1000, nsamples=1000)
