...
def get_args(parser):
    parser.add_argument('--dataset', default='mnist', help='mnist | cifar10 | cifar100 | lsun | imagenet | folder | lfw ')
    parser.add_argument('--dataroot', default='model/MMD-GAN/', help='path to dataset')
